export const uk = {
  ...
  'subscribe.trial_button': 'Запитати 7-денний безкоштовний пробний період',
  ...
  'translation.free_plan_limit':
    '{plan} дозволяє мати до {count} карток у своїй колекції.',
  'translation.per_day':
    'Після досягнення ліміту можна зберігати не більше {count} карток на день.',
  ...
  'rate.feedback_note':
    '. Я серйозно ставлюся до кожного відгуку. Ми можемо покращити цей проект разом.',
